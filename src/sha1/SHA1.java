...
public class SHA1 {
    ...
    public static String convertToBinary(String word) {
        ...
        System.out.println("Word length: " + word.length() + " bytes length:" + bytes.length);
    ...
    public static String createMessageLength(String message, String paddedOne, int zeros, String endLength) {
        ...
        System.out.println(messageBinary.toString().length());
        ...
        System.out.println("mArray" + mArray.length);
        System.out.println("Count: " + count);
        hash(mArray);
    ...
    private static String hash(int[] z) {
        ...
        System.out.println("Int count: " + integer_count);
        ...
        System.out.println("h1: " + h1Length);
        System.out.println("h2: " + h2Length);
        System.out.println("h3: " + h3Length);
        System.out.println("h4: " + h4Length);
        System.out.println("h5: " + h5Length);
